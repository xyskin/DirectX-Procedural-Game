	 ...
	 ID3D11ShaderResourceView* texture)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, lightDirection, diffuseColor,ambientColor, texture);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix,
	...
	D3DXVECTOR4 diffuseColor, D3DXVECTOR4 ambientColor, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
