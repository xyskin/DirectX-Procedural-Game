...
{
	return m_keyboardState[DIK_A] & 0x80 ? true : false;
}


bool InputClass::IsZPressed()
{
	return m_keyboardState[DIK_Z] & 0x80 ? true : false;
}


bool InputClass::IsPgUpPressed()
{
	return m_keyboardState[DIK_PGUP] & 0x80 ? true : false;
}


bool InputClass::IsPgDownPressed()
{
	return m_keyboardState[DIK_PGDN] & 0x80 ? true : false;
}

bool InputClass::IsIDown() {
	static int time = 0;
