...
void PositionClass::TurnLeft(bool keydown, float camX, float camZ)
{
	float radians;
	...
	case Vehicle:
		break;
	case Front:
		m_positionX = camX + 1*sinf(m_rotationY * 2 * MATH_PI / 360.0f);
		m_positionZ = camZ + 1*cosf(m_rotationY * 2 * MATH_PI / 360.0f);
		break;
	case Back:
		m_positionX = camX + 1*sinf((m_rotationY + 180.0f) * 2 * MATH_PI / 360.0f);
		m_positionZ = camZ + 1*cosf((m_rotationY + 180.0f) * 2 * MATH_PI / 360.0f);
		break;
	case Left:
		m_positionX = camX + 1*sinf((m_rotationY - 90.0f) * 2 * MATH_PI / 360.0f);
		m_positionZ = camZ + 1*cosf((m_rotationY - 90.0f) * 2 * MATH_PI / 360.0f);
		break;
	case Right:
		m_positionX = camX + 1*sinf((m_rotationY + 90.0f) * 2 * MATH_PI / 360.0f);
		m_positionZ = camZ + 1*cosf((m_rotationY + 90.0f) * 2 * MATH_PI / 360.0f);
...
void PositionClass::TurnRight(bool keydown, float camX, float camZ)
{
	float radians;
...
void PositionClass::SetObjectParts(Parts parts) 
{
	m_Parts = parts;
}